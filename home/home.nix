...
#  services.vscode-server.enable = true;
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-ef924996-9b38-4bed-8ddf-92c90360ae2b" = [ ];
      ...
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-0-toggle" = [ ];
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-1-increase-shade" = [ ];
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-2-decrease-shade" = [ ];
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-3-increase-darkness" = [ ];
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-4-decrease-darkness" = [ ];
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-5-change-color" = [ ];
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-6-toggle-shaded-scrollbar" = [ ];
      "org.chromium.Chromium"."527F06B25ECFEE3E8CF00F95D554775E-7-toggle-shade-fullscreen" = [ ];
      "org.chromium.Chromium"."E2D90C2E54FC8EAC6C5ADF4532CEBE8F-autofill_card" = [ ];
      "org.chromium.Chromium"."E2D90C2E54FC8EAC6C5ADF4532CEBE8F-autofill_identity" = [ ];
      "org.chromium.Chromium"."E2D90C2E54FC8EAC6C5ADF4532CEBE8F-autofill_login" = [ ];
      "org.chromium.Chromium"."E2D90C2E54FC8EAC6C5ADF4532CEBE8F-generate_password" = [ ];
      "org.chromium.Chromium"."E2D90C2E54FC8EAC6C5ADF4532CEBE8F-lock_vault" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,9,24,19,41,22.745";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."ef924996-9b38-4bed-8ddf-92c90360ae2b" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "ef924996-9b38-4bed-8ddf-92c90360ae2b";
      ...
      "katerc"."lspclient"."BlockedServerCommandLines" = "/etc/profiles/per-user/anrzej/bin/nil";
      ...
      "kcminputrc"."Libinput/0/0/Raydium Touchscreen"."Enabled" = true;
      "kcminputrc"."Libinput/2/10/TPPS\\/2 Elan TrackPoint"."PointerAcceleration" = 0.600;
      "kcminputrc"."Libinput/2/7/SynPS\\/2 Synaptics TouchPad"."NaturalScroll" = true;
      "kcminputrc"."Libinput/2/7/SynPS\\/2 Synaptics TouchPad"."PointerAcceleration" = 1.000;
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/nix/store/x0sjb08haxylkf9258iaka9a80d2z9mf-plasma-workspace-wallpapers-6.3.6/share/wallpapers/ColdRipple/";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/nix/store/x0sjb08haxylkf9258iaka9a80d2z9mf-plasma-workspace-wallpapers-6.3.6/share/wallpapers/ColdRipple/";
      "ksplashrc"."KSplash"."Engine" = "none";
      "ksplashrc"."KSplash"."Theme" = "None";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "b7f11dfe-402a-471b-a2b7-439597fdcb75";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/anrzej/nixos-config/flake.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1566;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,702,204";
